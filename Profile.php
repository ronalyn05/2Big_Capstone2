                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="contactno"><h4>Mobile</h4></label>
                              <input type="number" class="form-control" name="contactno" id="contactno" placeholder="enter mobile number" title="enter your mobile number if any.">
                          </div>
                      </div>
                      <div class="form-group">
                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                ...
                                <button class="btn btn-lg btn-outline-danger pull-right" style=" color: #FA8072; border-color: #FA8072 " type="exit"><a href="dashboard.php"><i class="glyphicon glyphicon-backward"></i>Exit </a> </button>
                            </div>
                      </div>
                </form>
