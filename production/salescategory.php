...
<button type="button" class="btn btn-outline-danger btn-sm" data-dismiss="modal" style="margin-right: 42%"> <a href="dashboard.php"><i class="fa fa-times"></i> Exit </a></button>
<div class="row" >
