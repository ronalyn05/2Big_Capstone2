...
<h1 style="background-color: #007bff;; height: 50px; color: white" align="center">Sales Report</h1>
 <button type="button" class="btn btn-outline-danger btn-sm" data-dismiss="modal" style="margin-right: 42%"> <a href="customer.php"><i class="fa fa-times"></i> Exit </a></button>
<div class="row" >
