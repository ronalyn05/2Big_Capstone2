      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="production/dashboard.php">
              <h1 style="color: #00348d">Login Form</h1>
              <div>
              ...
              <div class="clearfix"></div>
                ...
                <div>
                  <h1 style="color: #00348d"><i class="fa fa-tint fa-spin"></i> Water Refilling Management System</h1>
                </div>
              </div>
            </form>
          </section>
